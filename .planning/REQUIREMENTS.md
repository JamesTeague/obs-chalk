...
- [ ] **CORE-01**: Plugin registers as an OBS input source that composites as a transparent overlay in the scene
...
- [ ] **CORE-05**: Plugin builds against OBS 31.x+ using obs-plugintemplate and CMake
